...
from src.physics_losses import physics_loss
...
def main():
    ...
    ap.add_argument("--ckpt", default="checkpoints/fno_synth_physics.pt")
    args = ap.parse_args()
